          ...
          if (block.classList.contains('expanded')) {
            ...
            fetch(productUrl, {
              ...
              .then((response) => {
               ...
               //Globo Swatch Edit
            	var productGloboQuickviewJson = newDetail.querySelector(".globo-swatch-product-quickview");
            	if ( !productGloboQuickviewJson ) {
            	 return false;
            	}
            	var productGloboQuickview = productGloboQuickviewJson.innerHTML,
            		productGloboQuickview = JSON.parse(productGloboQuickview || '{}');
            	window.featuredProduct = productGloboQuickview.featuredProduct;
            	window.curVariant = productGloboQuickview.curVariant;
            	window.options_with_values = productGloboQuickview.options_with_values;
            	window.has_only_default_variant = productGloboQuickview.has_only_default_variant;
            	if (typeof globoswatch !== 'undefined' && document.querySelector('body.template-product') == null) {
            	  globoswatch.init();
            	}
            	//End Globo Swatch Edit
