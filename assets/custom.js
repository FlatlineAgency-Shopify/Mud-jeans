...
// this is Fitle add to cart handler
document.addEventListener('on:cart:add', function(evt) {
let addedProduct = evt.detail.response;
let product_id = addedProduct.product_id;
if(!product_id){
return ;
}
let size = ''
size = addedProduct.variant_title;
ftltag('event', 'cart', {
product_id,size
});
});
